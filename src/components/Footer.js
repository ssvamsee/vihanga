        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              {/* <span className="text-2xl font-bold text-white">Vihanga</span> */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#services" className="hover:text-primary-500 transition-colors">Our Services</a></li>
              <li><a href="#universities" className="hover:text-primary-500 transition-colors">Universities</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#universities" className="hover:text-primary-500 transition-colors">University Admissions</a></li>
              <li><a href="#services" className="hover:text-primary-500 transition-colors">Career Counseling</a></li>
              <li><a href="#services" className="hover:text-primary-500 transition-colors">Visa Assistance</a></li>
              <li><a href="#services" className="hover:text-primary-500 transition-colors">Test Preparation</a></li>
              <li><a href="#services" className="hover:text-primary-500 transition-colors">Scholarship Guidance</a></li>
            </ul>
          </div>
              ...
              <li className="flex items-start space-x-3">
                <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                              ...
                              <span className="text-gray-400">3rd Floor, Sree Residency, behind Sarathi Studio, Ameerpet, Hyderabad</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">director@vihanga.org</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-6 h-6 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Vihanga. All rights reserved.
            </div>
